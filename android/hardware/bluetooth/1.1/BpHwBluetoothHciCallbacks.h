...
struct ANDROIDHARDWAREBLUETOOTH11_API BpHwBluetoothHciCallbacks : public ::android::hardware::BpInterface<IBluetoothHciCallbacks>, public ::android::hardware::details::HidlInstrumentor {
