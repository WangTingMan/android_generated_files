 ...
 */
struct ANDROIDHARDWAREBLUETOOTH11_API IBluetoothHci : public ::android::hardware::bluetooth::V1_0::IBluetoothHci {
    /**
     ...
     */
    static constexpr const char* descriptor = "android.hardware.bluetooth@1.1::IBluetoothHci";
