...
struct IBluetoothHci : public ::android::hardware::bluetooth::V1_0::IBluetoothHci {
     ...
     */
    virtual ::android::hardware::Return<void> initialize(const ::android::sp<::android::hardware::bluetooth::V1_0::IBluetoothHciCallbacks>& callback) override = 0;
     ...
     */
    virtual ::android::hardware::Return<void> sendHciCommand(const ::android::hardware::hidl_vec<uint8_t>& command) override = 0;
     ...
     */
    virtual ::android::hardware::Return<void> sendAclData(const ::android::hardware::hidl_vec<uint8_t>& data) override = 0;
     ...
     * @param data HCI data packet to be sent
     */
    virtual ::android::hardware::Return<void> sendScoData(const ::android::hardware::hidl_vec<uint8_t>& data) override = 0;

    /**
     * Close the HCI interface
     */
    virtual ::android::hardware::Return<void> close() override = 0;
