 ...
 */
struct ANDROIDHARDWAREBLUETOOTHAUDIO20_EXPORTS CodecCapabilities final {
    // Forward declaration for forward reference support:
    struct Capabilities;

    struct ANDROIDHARDWAREBLUETOOTHAUDIO20_EXPORTS Capabilities final {
 ...
 */
struct ANDROIDHARDWAREBLUETOOTHAUDIO20_EXPORTS AudioCapabilities final {
    enum class hidl_discriminator : uint8_t {
 ...
 * AptX and AptX-HD both use the AptxParameters field.
 */
struct ANDROIDHARDWAREBLUETOOTHAUDIO20_EXPORTS CodecConfiguration final {
    // Forward declaration for forward reference support:
    struct CodecSpecific;

    struct ANDROIDHARDWAREBLUETOOTHAUDIO20_EXPORTS CodecSpecific final {
        enum class hidl_discriminator : uint8_t {
 ...
 */
struct ANDROIDHARDWAREBLUETOOTHAUDIO20_EXPORTS AudioConfiguration final {
    enum class hidl_discriminator : uint8_t {
