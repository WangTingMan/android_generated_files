...
struct ANDROIDHARDWAREBLUETOOTHAUDIO20_EXPORTS BpHwBluetoothAudioProvidersFactory : public ::android::hardware::BpInterface<IBluetoothAudioProvidersFactory>, public ::android::hardware::details::HidlInstrumentor {
