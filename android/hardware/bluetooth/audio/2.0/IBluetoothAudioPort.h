 ...
 */
struct ANDROIDHARDWAREBLUETOOTHAUDIO20_EXPORTS IBluetoothAudioPort : public ::android::hidl::base::V1_0::IBase {
    /**
     ...
     */
    inline static constexpr const char* descriptor = "android.hardware.bluetooth.audio@2.0::IBluetoothAudioPort";
