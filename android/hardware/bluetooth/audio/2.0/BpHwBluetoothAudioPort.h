...
struct ANDROIDHARDWAREBLUETOOTHAUDIO20_EXPORTS BpHwBluetoothAudioPort : public ::android::hardware::BpInterface<IBluetoothAudioPort>, public ::android::hardware::details::HidlInstrumentor {
