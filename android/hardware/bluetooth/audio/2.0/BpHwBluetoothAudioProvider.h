...
struct ANDROIDHARDWAREBLUETOOTHAUDIO20_EXPORTS BpHwBluetoothAudioProvider : public ::android::hardware::BpInterface<IBluetoothAudioProvider>, public ::android::hardware::details::HidlInstrumentor {
