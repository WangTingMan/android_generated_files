 ...
 */
struct ANDROIDHARDWAREBLUETOOTHAUDIO20_EXPORTS IBluetoothAudioProvidersFactory : public ::android::hidl::base::V1_0::IBase {
    /**
     ...
     */
    static constexpr const char* descriptor = "android.hardware.bluetooth.audio@2.0::IBluetoothAudioProvidersFactory";
