...
struct IBluetoothAudioProvidersFactory : public ::android::hardware::bluetooth::audio::V2_0::IBluetoothAudioProvidersFactory {
     ...
     */
    virtual ::android::hardware::Return<void> openProvider(::android::hardware::bluetooth::audio::V2_0::SessionType sessionType, openProvider_cb _hidl_cb) override = 0;
     ...
     *    encoding.
     */
    virtual ::android::hardware::Return<void> getProviderCapabilities(::android::hardware::bluetooth::audio::V2_0::SessionType sessionType, getProviderCapabilities_cb _hidl_cb) override = 0;
