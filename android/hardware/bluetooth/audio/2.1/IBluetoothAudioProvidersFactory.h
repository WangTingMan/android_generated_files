 ...
 */
struct ANDROIDHARDWAREBLUETOOTHAUDIO21_EXPORTS IBluetoothAudioProvidersFactory : public ::android::hardware::bluetooth::audio::V2_0::IBluetoothAudioProvidersFactory {
    /**
