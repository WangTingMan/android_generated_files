...
struct IBluetoothAudioProvider : public ::android::hardware::bluetooth::audio::V2_0::IBluetoothAudioProvider {
     ...
     */
    virtual ::android::hardware::Return<void> startSession(const ::android::sp<::android::hardware::bluetooth::audio::V2_0::IBluetoothAudioPort>& hostIf, const ::android::hardware::bluetooth::audio::V2_0::AudioConfiguration& audioConfig, startSession_cb _hidl_cb) override = 0;
     ...
     */
    virtual ::android::hardware::Return<void> streamStarted(::android::hardware::bluetooth::audio::V2_0::Status status) override = 0;
     ...
     * @param status SUCCESS or FAILURE
     */
    virtual ::android::hardware::Return<void> streamSuspended(::android::hardware::bluetooth::audio::V2_0::Status status) override = 0;
