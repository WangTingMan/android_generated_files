...
#include <android\hardware\audio\common\5.0\ANDROIDHARDWAREAUDIOCOMMON50_.h>
...
namespace common {
namespace V5_0 {
::android::status_t ANDROIDHARDWAREAUDIOCOMMON50_EXPORTS readEmbeddedFromParcel(
        const ::android::hardware::audio::common::V5_0::DeviceAddress &obj,
        const ::android::hardware::Parcel &parcel,
        size_t parentHandle,
        size_t parentOffset);

::android::status_t ANDROIDHARDWAREAUDIOCOMMON50_EXPORTS writeEmbeddedToParcel(
        const ::android::hardware::audio::common::V5_0::DeviceAddress &obj,
