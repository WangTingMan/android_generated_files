...
class ANDROIDHARDWAREBLUETOOTHRANGINGV1NDK_API IBluetoothChannelSoundingSession : public ::ndk::ICInterface {
public:
  typedef IBluetoothChannelSoundingSessionDelegator DefaultDelegator;
  static inline constexpr const char* descriptor = "android.hardware.bluetooth.ranging.IBluetoothChannelSoundingSession";
...
class ANDROIDHARDWAREBLUETOOTHRANGINGV1NDK_API IBluetoothChannelSoundingSessionDefault : public IBluetoothChannelSoundingSession {
public:
