...
class ANDROIDHARDWAREBLUETOOTHRANGINGV1NDK_API IBluetoothChannelSounding : public ::ndk::ICInterface {
public:
  typedef IBluetoothChannelSoundingDelegator DefaultDelegator;
  static inline constexpr const char* descriptor = "android.hardware.bluetooth.ranging.IBluetoothChannelSounding";
...
class ANDROIDHARDWAREBLUETOOTHRANGINGV1NDK_API IBluetoothChannelSoundingDefault : public IBluetoothChannelSounding {
public:
