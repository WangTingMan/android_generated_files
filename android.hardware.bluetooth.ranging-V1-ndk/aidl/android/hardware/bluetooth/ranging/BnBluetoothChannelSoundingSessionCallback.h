...
namespace bluetooth {
namespace ranging {
class ANDROIDHARDWAREBLUETOOTHRANGINGV1NDK_API BnBluetoothChannelSoundingSessionCallback : public ::ndk::BnCInterface<IBluetoothChannelSoundingSessionCallback> {
public:
