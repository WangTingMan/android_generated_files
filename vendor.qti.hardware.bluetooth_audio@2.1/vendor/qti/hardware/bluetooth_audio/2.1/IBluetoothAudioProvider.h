#ifndef HIDL_GENERATED_VENDOR_QTI_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPROVIDER_H
#define HIDL_GENERATED_VENDOR_QTI_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPROVIDER_H
 ...
 */
struct VENDORQTIHARDWAREBLUETOOTHAUDIO21_API IBluetoothAudioProvider : public ::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.qti.hardware.bluetooth_audio@2.1::IBluetoothAudioProvider"
     */
    static inline constexpr const char* descriptor = "vendor.qti.hardware.bluetooth_audio@2.1::IBluetoothAudioProvider";
     ...
     */
    using startSession_cb = std::function<void(::vendor::qti::hardware::bluetooth_audio::V2_0::Status status, const ::android::hardware::MQDescriptorSync<uint8_t>& dataMQ)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<void> startSession(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioPort>& hostIf, const ::vendor::qti::hardware::bluetooth_audio::V2_0::AudioConfiguration& audioConfig, startSession_cb _hidl_cb) override = 0;
     ...
     */
    virtual ::android::hardware::Return<void> streamStarted(::vendor::qti::hardware::bluetooth_audio::V2_0::Status status) override = 0;
     ...
     * @param status SUCCESS or FAILURE
     */
    virtual ::android::hardware::Return<void> streamSuspended(::vendor::qti::hardware::bluetooth_audio::V2_0::Status status) override = 0;

    /**
     * Call to update Sesion Parameters in runtime
     *
     */
    virtual ::android::hardware::Return<void> updateSessionParams(const ::vendor::qti::hardware::bluetooth_audio::V2_0::SessionParams& sessionParams) override = 0;
     ...
     */
    using startSession_2_1_cb = std::function<void(::vendor::qti::hardware::bluetooth_audio::V2_0::Status status, const ::android::hardware::MQDescriptorSync<uint8_t>& dataMQ)>;
    /**
     * This method indicates that the Bluetooth stack is ready to stream audio.
     * It registers an instance of IBluetoothAudioPort with and provides the
     * current negotiated codec to the Audio HAL. After this method is called,
     ...
     *    Invalid if streaming is offloaded to hardware or on failure.
     */
    virtual ::android::hardware::Return<void> startSession_2_1(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioPort>& hostIf, const ::vendor::qti::hardware::bluetooth_audio::V2_1::AudioConfiguration& audioConfig, startSession_2_1_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioProvider>> castFrom(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioProvider>> castFrom(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioProvider>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioProvider>& o);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioProvider>& o) {
    ...
    os += ::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioProvider::descriptor;
    os += "]";
