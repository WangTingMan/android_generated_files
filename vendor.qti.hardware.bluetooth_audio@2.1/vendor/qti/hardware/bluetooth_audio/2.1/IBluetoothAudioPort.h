#ifndef HIDL_GENERATED_VENDOR_QTI_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPORT_H
#define HIDL_GENERATED_VENDOR_QTI_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPORT_H
 ...
 */
struct VENDORQTIHARDWAREBLUETOOTHAUDIO21_API IBluetoothAudioPort : public ::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioPort {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.qti.hardware.bluetooth_audio@2.1::IBluetoothAudioPort"
     */
    static inline constexpr const char* descriptor = "vendor.qti.hardware.bluetooth_audio@2.1::IBluetoothAudioPort";
     ...
     */
    virtual ::android::hardware::Return<void> startStream() override = 0;
     ...
     * the data path open.
     */
    virtual ::android::hardware::Return<void> suspendStream() override = 0;
     ...
     */
    virtual ::android::hardware::Return<void> stopStream() override = 0;

    /**
     * Return callback for getPresentationPosition
     */
    using getPresentationPosition_cb = std::function<void(::vendor::qti::hardware::bluetooth_audio::V2_0::Status status, uint64_t remoteDeviceAudioDelayNanos, uint64_t transmittedOctets, const ::vendor::qti::hardware::bluetooth_audio::V2_0::TimeSpec& transmittedOctetsTimeStamp)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<void> getPresentationPosition(getPresentationPosition_cb _hidl_cb) override = 0;
     ...
     */
    virtual ::android::hardware::Return<void> updateAptxMode(uint16_t aptxMode) override = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioPort>> castFrom(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioPort>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioPort>> castFrom(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioPort>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioPort>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioPort>& o);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioPort>& o) {
    ...
    os += ::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioPort::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_QTI_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPORT_H
