...
::android::hardware::Return<void> IBluetoothAudioProvidersFactory::getHashChain(getHashChain_cb _hidl_cb){
    ...
    uint8_t v1Detailes[] = { 207,25,169,94,76,114,87,15,202,137,98,240,223,156,147,52,23,140,112,25,81,246,129,246,175,166,251,68,30,223,131,253 };
    for( auto i = 0; i < 32; ++i )
    {
        v1[i] = v1Detailes[i];
    }

    uint8_t v2Detailes[] = { 149,223,184,46,121,252,71,129,59,143,79,119,59,30,182,15,121,234,126,66,225,38,66,53,107,223,20,225,68,8,151,88 };
    for( auto i = 0; i < 32; ++i )
    {
        v2[i] = v2Detailes[i];
    }
