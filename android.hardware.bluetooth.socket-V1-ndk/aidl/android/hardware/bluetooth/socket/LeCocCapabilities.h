...
public:
  ...
  inline bool operator==(const LeCocCapabilities& _rhs) const {
    return std::tie(numberOfSupportedSockets, mtu) == std::tie(_rhs.numberOfSupportedSockets, _rhs.mtu);
  }
  inline bool operator<(const LeCocCapabilities& _rhs) const {
    return std::tie(numberOfSupportedSockets, mtu) < std::tie(_rhs.numberOfSupportedSockets, _rhs.mtu);
  }
