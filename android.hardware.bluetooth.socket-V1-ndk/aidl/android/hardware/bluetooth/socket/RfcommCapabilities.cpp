...
namespace bluetooth {
namespace socket {
const char* RfcommCapabilities::descriptor = "android.hardware.bluetooth.socket.RfcommCapabilities";

binder_status_t RfcommCapabilities::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t RfcommCapabilities::writeToParcel(AParcel* _aidl_parcel) const {
