...
namespace bluetooth {
namespace socket {
const char* LeCocChannelInfo::descriptor = "android.hardware.bluetooth.socket.LeCocChannelInfo";

binder_status_t LeCocChannelInfo::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &psm);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &localMps);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &remoteMps);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
...
binder_status_t LeCocChannelInfo::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, psm);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, localMps);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, remoteMps);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
