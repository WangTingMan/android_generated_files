...
namespace audio {
namespace effect {
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API Virtualizer {
public:
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API SpeakerAnglesPayload {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API ChannelAngle {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
