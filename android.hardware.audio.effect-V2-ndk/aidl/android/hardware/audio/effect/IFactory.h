...
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API IFactory : public ::ndk::ICInterface {
public:
...
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API IFactoryDefault : public IFactory {
public:
