...
namespace audio {
namespace effect {
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API DynamicsProcessing {
public:
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API StageEnablement {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API EngineArchitecture {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API ChannelConfig {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API EqBandConfig {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API MbcBandConfig {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API LimiterConfig {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API InputGain {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
