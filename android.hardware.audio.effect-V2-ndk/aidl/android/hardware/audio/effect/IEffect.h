...
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API IEffect : public ::ndk::ICInterface {
public:
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API Status {
  public:
...
#undef __attribute__
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API OpenEffectReturn {
  public:
  ...
  static inline const std::string hash = "54d5a2e1d59066b57e35eb7bcb5ebc72a1259c1c";
...
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API IEffectDefault : public IEffect {
public:
