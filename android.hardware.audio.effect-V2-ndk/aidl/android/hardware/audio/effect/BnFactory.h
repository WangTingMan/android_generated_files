...
namespace audio {
namespace effect {
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API BnFactory : public ::ndk::BnCInterface<IFactory> {
public:
  BnFactory();
  virtual ~BnFactory();
...
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API IFactoryDelegator : public BnFactory {
public:
