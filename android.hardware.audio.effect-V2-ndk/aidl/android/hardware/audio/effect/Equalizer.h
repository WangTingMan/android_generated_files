...
namespace audio {
namespace effect {
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API Equalizer {
public:
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API BandLevel {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API BandFrequency {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API Preset {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
