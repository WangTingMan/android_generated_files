...
namespace audio {
namespace effect {
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API Processing {
public:
  typedef std::false_type fixed_size;
  static const char* descriptor;

  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API Type {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
...
template <>
constexpr inline std::array<aidl::android::hardware::audio::effect::Processing::Type::Tag, 2> enum_values<aidl::android::hardware::audio::effect::Processing::Type::Tag> = {
