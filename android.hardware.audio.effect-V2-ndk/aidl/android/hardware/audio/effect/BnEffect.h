...
namespace audio {
namespace effect {
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API BnEffect : public ::ndk::BnCInterface<IEffect> {
public:
  BnEffect();
  virtual ~BnEffect();
...
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API IEffectDelegator : public BnEffect {
public:
