...
namespace audio {
namespace effect {
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API Descriptor {
public:
  typedef std::false_type fixed_size;
  static const char* descriptor;

  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API Identity {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
