...
namespace audio {
namespace effect {
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API Visualizer {
public:
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API Measurement {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
