...
namespace audio {
namespace effect {
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API Parameter {
public:
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API Id {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API VolumeStereo {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API Specific {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
...
template <>
constexpr inline std::array<aidl::android::hardware::audio::effect::Parameter::Id::Tag, 18> enum_values<aidl::android::hardware::audio::effect::Parameter::Id::Tag> = {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template <>
constexpr inline std::array<aidl::android::hardware::audio::effect::Parameter::Specific::Tag, 17> enum_values<aidl::android::hardware::audio::effect::Parameter::Specific::Tag> = {
