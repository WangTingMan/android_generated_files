...
namespace audio {
namespace effect {
class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API HapticGenerator {
public:
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API HapticScale {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
    ...
    inline bool operator==(const HapticScale& _rhs) const {
      return std::tie(id, scale) == std::tie(_rhs.id, _rhs.scale);
    }
    inline bool operator<(const HapticScale& _rhs) const {
      return std::tie(id, scale) < std::tie(_rhs.id, _rhs.scale);
    }
  ...
  class ANDROIDHARDWAREAUDIOEFFECTV2NDK_API VibratorInformation {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
