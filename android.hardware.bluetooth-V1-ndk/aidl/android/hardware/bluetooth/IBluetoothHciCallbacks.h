...
class ANDROIDHARDWAREBLUETOOTHV1NDK_API IBluetoothHciCallbacks : public ::ndk::ICInterface {
public:
  typedef IBluetoothHciCallbacksDelegator DefaultDelegator;
  static inline constexpr const char* descriptor = "android.hardware.bluetooth.IBluetoothHciCallbacks";
...
class ANDROIDHARDWAREBLUETOOTHV1NDK_API IBluetoothHciCallbacksDefault : public IBluetoothHciCallbacks {
public:
