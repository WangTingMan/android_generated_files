...
namespace hardware {
namespace bluetooth {
class ANDROIDHARDWAREBLUETOOTHV1NDK_API BnBluetoothHci : public ::ndk::BnCInterface<IBluetoothHci> {
public:
  BnBluetoothHci();
...
class ANDROIDHARDWAREBLUETOOTHV1NDK_API IBluetoothHciDelegator : public BnBluetoothHci {
public:
