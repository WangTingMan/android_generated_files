...
static const char* _g_aidl_android_hardware_bluetooth_IBluetoothHciCallbacks_clazz_code_to_function[] = { "aclDataReceived","hciEventReceived","initializationComplete","isoDataReceived","scoDataReceived",};
static AIBinder_Class* _g_aidl_android_hardware_bluetooth_IBluetoothHciCallbacks_clazz = ::ndk::ICInterface::defineClass(IBluetoothHciCallbacks::descriptor, _aidl_android_hardware_bluetooth_IBluetoothHciCallbacks_onTransact, _g_aidl_android_hardware_bluetooth_IBluetoothHciCallbacks_clazz_code_to_function, 5);
...
#ifdef _MSC_VER
    setBinderCreater( std::bind( &BnBluetoothHciCallbacks::createBinderDetail, this ) );
#endif
}
BnBluetoothHciCallbacks::~BnBluetoothHciCallbacks() {}
...
::ndk::SpAIBinder BnBluetoothHciCallbacks::createBinderDetail() {
