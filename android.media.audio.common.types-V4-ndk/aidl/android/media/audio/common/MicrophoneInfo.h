...
namespace audio {
namespace common {
class ANDROIDMEDIAAUDIOCOMMONTYPESV4NDK_API MicrophoneInfo {
public:
  ...
  class ANDROIDMEDIAAUDIOCOMMONTYPESV4NDK_API Sensitivity {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDMEDIAAUDIOCOMMONTYPESV4NDK_API FrequencyResponsePoint {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDMEDIAAUDIOCOMMONTYPESV4NDK_API Coordinate {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
