...
::android::hardware::Return<void> IServiceManager::getHashChain(getHashChain_cb _hidl_cb){
    std::array<uint8_t, 32> valus1{ 111,58,138,63,212,191,189,2,228,230,28,115,45,45,246,22,255,105,67,74,30,216,60,218,51,115,3,173,198,215,20,223 } /* 6f3a8a3fd4bfbd02e4e61c732d2df616ff69434a1ed83cda337303adc6d714df */;
    std::array<uint8_t, 32> valus2{ 11,148,220,135,111,116,158,210,74,152,246,28,65,212,106,215,90,39,81,17,99,241,150,138,8,66,19,163,60,104,78,246 } /* 0b94dc876f749ed24a98f61c41d46ad75a27511163f1968a084213a33c684ef6 */;
    std::array<uint8_t, 32> valus3{ 133,57,79,138,13,21,231,251,46,228,92,82,209,251,139,143,211,193,60,51,62,99,199,140,74,161,255,134,132,12,246,220 } /* 85394f8a0d15e7fb2ee45c52d1fb8b8fd3c13c333e63c78c4aa1ff86840cf6dc */;
    std::array<uint8_t, 32> valus4{ 236,127,215,158,208,45,250,133,188,73,148,38,173,174,62,190,35,239,5,36,243,205,105,87,19,147,36,184,59,24,202,76 } /* ec7fd79ed02dfa85bc499426adae3ebe23ef0524f3cd6957139324b83b18ca4c */;
    ::android::hardware::hidl_vec<::android::hardware::hidl_array<uint8_t, 32>> hid_{ valus1, valus2, valus3, valus4 };
    _hidl_cb( hid_ );
...
::android::hardware::Return<bool> BpHwServiceManager::_hidl_registerClientCallback(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& fqName, const ::android::hardware::hidl_string& name, const ::android::sp<::android::hidl::base::V1_0::IBase>& server, const ::android::sp<::android::hidl::manager::V1_2::IClientCallback>& cb) {
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(10 /* registerClientCallback */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::hardware::Return<bool> BpHwServiceManager::_hidl_unregisterClientCallback(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::hidl::base::V1_0::IBase>& server, const ::android::sp<::android::hidl::manager::V1_2::IClientCallback>& cb) {
    ...
    ::android::hardware::ProcessState::self()->startThreadPool();
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(11 /* unregisterClientCallback */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::hardware::Return<void> BpHwServiceManager::_hidl_listManifestByInterface(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& fqName, listManifestByInterface_cb _hidl_cb) {
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(13 /* listManifestByInterface */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::hardware::Return<bool> BpHwServiceManager::_hidl_tryUnregister(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& fqName, const ::android::hardware::hidl_string& name, const ::android::sp<::android::hidl::base::V1_0::IBase>& service) {
    ...
    ::android::hardware::ProcessState::self()->startThreadPool();
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(14 /* tryUnregister */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
