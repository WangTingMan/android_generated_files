 ...
 */
struct ANDROIDHIDLTOKEN10_API ITokenManager : public ::android::hidl::base::V1_0::IBase {
    /**
     ...
     */
    static constexpr const char* const descriptor = "android.hidl.token@1.0::ITokenManager";
