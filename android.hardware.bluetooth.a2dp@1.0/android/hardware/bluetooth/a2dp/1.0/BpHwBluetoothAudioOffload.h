...
struct ANDROIDHARDWAREBLUETOOTHA2DP10_API BpHwBluetoothAudioOffload : public ::android::hardware::BpInterface<IBluetoothAudioOffload>, public ::android::hardware::details::HidlInstrumentor {
