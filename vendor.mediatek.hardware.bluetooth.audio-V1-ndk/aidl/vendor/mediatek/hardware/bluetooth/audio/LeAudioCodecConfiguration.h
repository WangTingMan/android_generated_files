...
namespace bluetooth {
namespace audio {
class VENDORMEDIATEKHARDWAREBLUETOOTHAUDIOV1NDK_API LeAudioCodecConfiguration {
public:
  ...
  LeAudioCodecConfiguration() : _value(std::in_place_index<static_cast<size_t>(lc3Config)>, ::aidl::vendor::mediatek::hardware::bluetooth::audio::Lc3Configuration()) { }

  template <typename _Tp, typename = std::enable_if_t<
      _not_self<_Tp> &&
      std::is_constructible_v<std::variant<::aidl::vendor::mediatek::hardware::bluetooth::audio::Lc3Configuration, ::aidl::vendor::mediatek::hardware::bluetooth::audio::LeAudioCodecConfiguration::VendorConfiguration>, _Tp>
    >>
...
private:
  std::variant<::aidl::vendor::mediatek::hardware::bluetooth::audio::Lc3Configuration, ::aidl::vendor::mediatek::hardware::bluetooth::audio::LeAudioCodecConfiguration::VendorConfiguration> _value;
};
}  // namespace audio
}  // namespace bluetooth
}  // namespace hardware
...
template <>
constexpr inline std::array<aidl::vendor::mediatek::hardware::bluetooth::audio::LeAudioCodecConfiguration::Tag, 2> enum_values<aidl::vendor::mediatek::hardware::bluetooth::audio::LeAudioCodecConfiguration::Tag> = {
  aidl::vendor::mediatek::hardware::bluetooth::audio::LeAudioCodecConfiguration::Tag::lc3Config,
  aidl::vendor::mediatek::hardware::bluetooth::audio::LeAudioCodecConfiguration::Tag::vendorConfig,
};
