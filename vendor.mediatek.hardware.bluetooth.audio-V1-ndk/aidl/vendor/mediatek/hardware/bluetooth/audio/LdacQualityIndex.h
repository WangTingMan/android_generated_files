...
template <>
constexpr inline std::array<aidl::vendor::mediatek::hardware::bluetooth::audio::LdacQualityIndex, 4> enum_values<aidl::vendor::mediatek::hardware::bluetooth::audio::LdacQualityIndex> = {
  aidl::vendor::mediatek::hardware::bluetooth::audio::LdacQualityIndex::HIGH,
  aidl::vendor::mediatek::hardware::bluetooth::audio::LdacQualityIndex::MID,
  aidl::vendor::mediatek::hardware::bluetooth::audio::LdacQualityIndex::LOW,
  aidl::vendor::mediatek::hardware::bluetooth::audio::LdacQualityIndex::ABR,
};
