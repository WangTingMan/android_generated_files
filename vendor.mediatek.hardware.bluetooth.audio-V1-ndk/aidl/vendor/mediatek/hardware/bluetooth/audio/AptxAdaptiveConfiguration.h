...
namespace bluetooth {
namespace audio {
class VENDORMEDIATEKHARDWAREBLUETOOTHAUDIOV1NDK_API AptxAdaptiveConfiguration {
public:
  typedef std::false_type fixed_size;
  static const char* descriptor;

  int32_t sampleRateHz = 0;
  ::aidl::vendor::mediatek::hardware::bluetooth::audio::AptxAdaptiveChannelMode channelMode = ::aidl::vendor::mediatek::hardware::bluetooth::audio::AptxAdaptiveChannelMode(0);
  int8_t bitsPerSample = 0;
  ::aidl::vendor::mediatek::hardware::bluetooth::audio::AptxMode aptxMode = ::aidl::vendor::mediatek::hardware::bluetooth::audio::AptxMode(0);
