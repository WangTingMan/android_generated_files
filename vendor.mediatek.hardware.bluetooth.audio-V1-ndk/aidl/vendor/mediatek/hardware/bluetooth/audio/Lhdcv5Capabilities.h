...
namespace bluetooth {
namespace audio {
class VENDORMEDIATEKHARDWAREBLUETOOTHAUDIOV1NDK_API Lhdcv5Capabilities {
public:
  ...
  std::vector<::aidl::vendor::mediatek::hardware::bluetooth::audio::Lhdcv5Version> codecVersion;
  std::vector<::aidl::vendor::mediatek::hardware::bluetooth::audio::Lhdcv5QualityIndex> qualityIndex;
  std::vector<::aidl::vendor::mediatek::hardware::bluetooth::audio::Lhdcv5QualityIndex> maxQualityIndex;
  std::vector<::aidl::vendor::mediatek::hardware::bluetooth::audio::Lhdcv5QualityIndex> minQualityIndex;
  std::vector<::aidl::vendor::mediatek::hardware::bluetooth::audio::Lhdcv5FrameDuration> frameDuration;
  std::vector<::aidl::vendor::mediatek::hardware::bluetooth::audio::Lhdcv5DataInterval> dataInterval;
  std::vector<::aidl::vendor::mediatek::hardware::bluetooth::audio::Lhdcv5Specific> codecSpecific_1;
  std::vector<::aidl::vendor::mediatek::hardware::bluetooth::audio::Lhdcv5Specific> codecSpecific_2;
  std::vector<uint8_t> metaData;

  binder_status_t readFromParcel(const AParcel* parcel);
  binder_status_t writeToParcel(AParcel* parcel) const;

  inline bool operator==(const Lhdcv5Capabilities& _rhs) const {
