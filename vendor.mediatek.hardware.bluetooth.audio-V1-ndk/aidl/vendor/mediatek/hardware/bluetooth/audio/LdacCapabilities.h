...
namespace bluetooth {
namespace audio {
class VENDORMEDIATEKHARDWAREBLUETOOTHAUDIOV1NDK_API LdacCapabilities {
public:
  typedef std::false_type fixed_size;
  static const char* descriptor;

  std::vector<int32_t> sampleRateHz;
  std::vector<::aidl::vendor::mediatek::hardware::bluetooth::audio::LdacChannelMode> channelMode;
  std::vector<::aidl::vendor::mediatek::hardware::bluetooth::audio::LdacQualityIndex> qualityIndex;
