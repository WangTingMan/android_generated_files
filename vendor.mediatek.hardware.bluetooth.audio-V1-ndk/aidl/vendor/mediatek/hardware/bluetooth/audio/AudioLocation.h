...
template <>
constexpr inline std::array<aidl::vendor::mediatek::hardware::bluetooth::audio::AudioLocation, 3> enum_values<aidl::vendor::mediatek::hardware::bluetooth::audio::AudioLocation> = {
  aidl::vendor::mediatek::hardware::bluetooth::audio::AudioLocation::UNKNOWN,
  aidl::vendor::mediatek::hardware::bluetooth::audio::AudioLocation::FRONT_LEFT,
  aidl::vendor::mediatek::hardware::bluetooth::audio::AudioLocation::FRONT_RIGHT,
};
