...
public:
  ...
  public:
    ...
    template <typename _Tp, typename = std::enable_if_t<
        _not_self<_Tp> &&
        std::is_constructible_v<std::variant<::aidl::vendor::mediatek::hardware::bluetooth::audio::SbcCapabilities, ::aidl::vendor::mediatek::hardware::bluetooth::audio::AacCapabilities, ::aidl::vendor::mediatek::hardware::bluetooth::audio::LdacCapabilities, ::aidl::vendor::mediatek::hardware::bluetooth::audio::AptxCapabilities, ::aidl::vendor::mediatek::hardware::bluetooth::audio::AptxAdaptiveCapabilities, ::aidl::vendor::mediatek::hardware::bluetooth::audio::Lc3Capabilities, ::aidl::vendor::mediatek::hardware::bluetooth::audio::CodecCapabilities::VendorCapabilities, ::aidl::vendor::mediatek::hardware::bluetooth::audio::Lhdcv5Capabilities>, _Tp>
      >>
