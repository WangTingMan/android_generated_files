...
namespace bluetooth {
namespace audio {
class VENDORMEDIATEKHARDWAREBLUETOOTHAUDIOV1NDK_API UnicastCapability {
public:
  ...
  class VENDORMEDIATEKHARDWAREBLUETOOTHAUDIOV1NDK_API LeAudioCodecCapabilities {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
    ...
    LeAudioCodecCapabilities() : _value(std::in_place_index<static_cast<size_t>(lc3Capabilities)>, ::aidl::vendor::mediatek::hardware::bluetooth::audio::Lc3Capabilities()) { }

    template <typename _Tp, typename = std::enable_if_t<
        _not_self<_Tp> &&
        std::is_constructible_v<std::variant<::aidl::vendor::mediatek::hardware::bluetooth::audio::Lc3Capabilities, ::aidl::vendor::mediatek::hardware::bluetooth::audio::UnicastCapability::VendorCapabilities>, _Tp>
      >>
  ...
  private:
    std::variant<::aidl::vendor::mediatek::hardware::bluetooth::audio::Lc3Capabilities, ::aidl::vendor::mediatek::hardware::bluetooth::audio::UnicastCapability::VendorCapabilities> _value;
  };
  ...
  ::aidl::vendor::mediatek::hardware::bluetooth::audio::UnicastCapability::LeAudioCodecCapabilities leAudioCodecCapabilities;
...
template <>
constexpr inline std::array<aidl::vendor::mediatek::hardware::bluetooth::audio::UnicastCapability::LeAudioCodecCapabilities::Tag, 2> enum_values<aidl::vendor::mediatek::hardware::bluetooth::audio::UnicastCapability::LeAudioCodecCapabilities::Tag> = {
  aidl::vendor::mediatek::hardware::bluetooth::audio::UnicastCapability::LeAudioCodecCapabilities::Tag::lc3Capabilities,
  aidl::vendor::mediatek::hardware::bluetooth::audio::UnicastCapability::LeAudioCodecCapabilities::Tag::vendorCapabillities,
};
