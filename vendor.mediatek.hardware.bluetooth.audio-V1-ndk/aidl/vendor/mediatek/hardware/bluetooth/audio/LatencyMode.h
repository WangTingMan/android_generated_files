...
template <>
constexpr inline std::array<aidl::vendor::mediatek::hardware::bluetooth::audio::LatencyMode, 3> enum_values<aidl::vendor::mediatek::hardware::bluetooth::audio::LatencyMode> = {
  aidl::vendor::mediatek::hardware::bluetooth::audio::LatencyMode::UNKNOWN,
  aidl::vendor::mediatek::hardware::bluetooth::audio::LatencyMode::LOW_LATENCY,
  aidl::vendor::mediatek::hardware::bluetooth::audio::LatencyMode::FREE,
};
