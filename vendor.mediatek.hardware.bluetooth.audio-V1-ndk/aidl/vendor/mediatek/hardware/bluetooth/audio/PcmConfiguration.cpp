...
namespace bluetooth {
namespace audio {
const char* PcmConfiguration::descriptor = "vendor.mediatek.hardware.bluetooth.audio.PcmConfiguration";
...
binder_status_t PcmConfiguration::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &isLowLatencyEnabled);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
...
binder_status_t PcmConfiguration::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, isLowLatencyEnabled);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
