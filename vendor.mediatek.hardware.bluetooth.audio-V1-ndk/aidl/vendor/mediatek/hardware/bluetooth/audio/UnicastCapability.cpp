...
namespace bluetooth {
namespace audio {
const char* UnicastCapability::descriptor = "vendor.mediatek.hardware.bluetooth.audio.UnicastCapability";
...
namespace bluetooth {
namespace audio {
const char* UnicastCapability::VendorCapabilities::descriptor = "vendor.mediatek.hardware.bluetooth.audio.UnicastCapability.VendorCapabilities";
...
namespace bluetooth {
namespace audio {
const char* UnicastCapability::LeAudioCodecCapabilities::descriptor = "vendor.mediatek.hardware.bluetooth.audio.UnicastCapability.LeAudioCodecCapabilities";
...
binder_status_t UnicastCapability::LeAudioCodecCapabilities::readFromParcel(const AParcel* _parcel) {
  ...
  case vendorCapabillities: {
    ::aidl::vendor::mediatek::hardware::bluetooth::audio::UnicastCapability::VendorCapabilities _aidl_value;
    if ((_aidl_ret_status = ::ndk::AParcel_readData(_parcel, &_aidl_value)) != STATUS_OK) return _aidl_ret_status;
    if constexpr (std::is_trivially_copyable_v<::aidl::vendor::mediatek::hardware::bluetooth::audio::UnicastCapability::VendorCapabilities>) {
