...
#include <aidl/vendor/mediatek/hardware/bluetooth/audio/PcmConfiguration.h>
...
namespace bluetooth {
namespace audio {
class VENDORMEDIATEKHARDWAREBLUETOOTHAUDIOV1NDK_API AudioConfiguration {
public:
  ...
  AudioConfiguration() : _value(std::in_place_index<static_cast<size_t>(pcmConfig)>, ::aidl::vendor::mediatek::hardware::bluetooth::audio::PcmConfiguration()) { }

  template <typename _Tp, typename = std::enable_if_t<
      _not_self<_Tp> &&
      std::is_constructible_v<std::variant<::aidl::vendor::mediatek::hardware::bluetooth::audio::PcmConfiguration, ::aidl::vendor::mediatek::hardware::bluetooth::audio::CodecConfiguration, ::aidl::vendor::mediatek::hardware::bluetooth::audio::LeAudioConfiguration, ::aidl::vendor::mediatek::hardware::bluetooth::audio::LeAudioBroadcastConfiguration>, _Tp>
    >>
...
private:
  std::variant<::aidl::vendor::mediatek::hardware::bluetooth::audio::PcmConfiguration, ::aidl::vendor::mediatek::hardware::bluetooth::audio::CodecConfiguration, ::aidl::vendor::mediatek::hardware::bluetooth::audio::LeAudioConfiguration, ::aidl::vendor::mediatek::hardware::bluetooth::audio::LeAudioBroadcastConfiguration> _value;
};
}  // namespace audio
}  // namespace bluetooth
}  // namespace hardware
...
template <>
constexpr inline std::array<aidl::vendor::mediatek::hardware::bluetooth::audio::AudioConfiguration::Tag, 4> enum_values<aidl::vendor::mediatek::hardware::bluetooth::audio::AudioConfiguration::Tag> = {
  aidl::vendor::mediatek::hardware::bluetooth::audio::AudioConfiguration::Tag::pcmConfig,
  aidl::vendor::mediatek::hardware::bluetooth::audio::AudioConfiguration::Tag::a2dpConfig,
  aidl::vendor::mediatek::hardware::bluetooth::audio::AudioConfiguration::Tag::leAudioConfig,
  aidl::vendor::mediatek::hardware::bluetooth::audio::AudioConfiguration::Tag::leAudioBroadcastConfig,
};
