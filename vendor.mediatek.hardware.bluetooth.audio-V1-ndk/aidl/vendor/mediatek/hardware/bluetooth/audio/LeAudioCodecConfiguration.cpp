...
namespace bluetooth {
namespace audio {
const char* LeAudioCodecConfiguration::descriptor = "vendor.mediatek.hardware.bluetooth.audio.LeAudioCodecConfiguration";
...
binder_status_t LeAudioCodecConfiguration::readFromParcel(const AParcel* _parcel) {
  ...
  case lc3Config: {
    ...
    return STATUS_OK; }
  case vendorConfig: {
    ::aidl::vendor::mediatek::hardware::bluetooth::audio::LeAudioCodecConfiguration::VendorConfiguration _aidl_value;
    if ((_aidl_ret_status = ::ndk::AParcel_readData(_parcel, &_aidl_value)) != STATUS_OK) return _aidl_ret_status;
    if constexpr (std::is_trivially_copyable_v<::aidl::vendor::mediatek::hardware::bluetooth::audio::LeAudioCodecConfiguration::VendorConfiguration>) {
...
namespace bluetooth {
namespace audio {
const char* LeAudioCodecConfiguration::VendorConfiguration::descriptor = "vendor.mediatek.hardware.bluetooth.audio.LeAudioCodecConfiguration.VendorConfiguration";
