...
template <>
constexpr inline std::array<aidl::vendor::mediatek::hardware::bluetooth::audio::SbcAllocMethod, 2> enum_values<aidl::vendor::mediatek::hardware::bluetooth::audio::SbcAllocMethod> = {
  aidl::vendor::mediatek::hardware::bluetooth::audio::SbcAllocMethod::ALLOC_MD_S,
  aidl::vendor::mediatek::hardware::bluetooth::audio::SbcAllocMethod::ALLOC_MD_L,
};
