...
namespace audio {
namespace common {
class ANDROIDMEDIAAUDIOCOMMONTYPESV2NDK_EXPORTS_API MicrophoneInfo {
public:
  ...
  class ANDROIDMEDIAAUDIOCOMMONTYPESV2NDK_EXPORTS_API Sensitivity {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDMEDIAAUDIOCOMMONTYPESV2NDK_EXPORTS_API FrequencyResponsePoint {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDMEDIAAUDIOCOMMONTYPESV2NDK_EXPORTS_API Coordinate {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
