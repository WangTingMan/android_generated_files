#ifndef HIDL_GENERATED_VENDOR_QTI_HARDWARE_BLUETOOTH_AUDIO_V2_0_IBLUETOOTHAUDIOPORT_H
#define HIDL_GENERATED_VENDOR_QTI_HARDWARE_BLUETOOTH_AUDIO_V2_0_IBLUETOOTHAUDIOPORT_H
 ...
 */
struct VENDORQTIHARDWAREBLUETOOTHAUDIO20_API IBluetoothAudioPort : public ::android::hidl::base::V1_0::IBase {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.qti.hardware.bluetooth_audio@2.0::IBluetoothAudioPort"
     */
    static inline constexpr const char* descriptor = "vendor.qti.hardware.bluetooth_audio@2.0::IBluetoothAudioPort";
     ...
     */
    virtual ::android::hardware::Return<void> updateAptxMode(uint16_t aptxMode) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioPort>> castFrom(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioPort>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioPort>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioPort>& o);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioPort>& o) {
    ...
    os += ::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioPort::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_QTI_HARDWARE_BLUETOOTH_AUDIO_V2_0_IBLUETOOTHAUDIOPORT_H
