#ifndef HIDL_GENERATED_VENDOR_QTI_HARDWARE_BLUETOOTH_AUDIO_V2_0_IBLUETOOTHAUDIOPROVIDER_H
#define HIDL_GENERATED_VENDOR_QTI_HARDWARE_BLUETOOTH_AUDIO_V2_0_IBLUETOOTHAUDIOPROVIDER_H
 ...
 */
struct VENDORQTIHARDWAREBLUETOOTHAUDIO20_API IBluetoothAudioProvider : public ::android::hidl::base::V1_0::IBase {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.qti.hardware.bluetooth_audio@2.0::IBluetoothAudioProvider"
     */
    static inline constexpr const char* descriptor = "vendor.qti.hardware.bluetooth_audio@2.0::IBluetoothAudioProvider";
     ...
     */
    virtual ::android::hardware::Return<void> startSession(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioPort>& hostIf, const ::vendor::qti::hardware::bluetooth_audio::V2_0::AudioConfiguration& audioConfig, startSession_cb _hidl_cb) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> streamStarted(::vendor::qti::hardware::bluetooth_audio::V2_0::Status status) = 0;
     ...
     * @param status SUCCESS or FAILURE
     */
    virtual ::android::hardware::Return<void> streamSuspended(::vendor::qti::hardware::bluetooth_audio::V2_0::Status status) = 0;

    /**
     * Call to update Sesion Parameters in runtime
     *
     */
    virtual ::android::hardware::Return<void> updateSessionParams(const ::vendor::qti::hardware::bluetooth_audio::V2_0::SessionParams& sessionParams) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider>> castFrom(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider>& o);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider>& o) {
    ...
    os += ::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_QTI_HARDWARE_BLUETOOTH_AUDIO_V2_0_IBLUETOOTHAUDIOPROVIDER_H
