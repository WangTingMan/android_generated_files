#ifndef HIDL_GENERATED_VENDOR_QTI_HARDWARE_BLUETOOTH_AUDIO_V2_0_IBLUETOOTHAUDIOPROVIDERSFACTORY_H
#define HIDL_GENERATED_VENDOR_QTI_HARDWARE_BLUETOOTH_AUDIO_V2_0_IBLUETOOTHAUDIOPROVIDERSFACTORY_H
 ...
 */
struct VENDORQTIHARDWAREBLUETOOTHAUDIO20_API IBluetoothAudioProvidersFactory : public ::android::hidl::base::V1_0::IBase {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.qti.hardware.bluetooth_audio@2.0::IBluetoothAudioProvidersFactory"
     */
    static inline constexpr const char* descriptor = "vendor.qti.hardware.bluetooth_audio@2.0::IBluetoothAudioProvidersFactory";
     ...
     */
    virtual ::android::hardware::Return<void> openProvider(::vendor::qti::hardware::bluetooth_audio::V2_0::SessionType sessionType, openProvider_cb _hidl_cb) = 0;
     ...
     *    encoding.
     */
    virtual ::android::hardware::Return<void> getProviderCapabilities(::vendor::qti::hardware::bluetooth_audio::V2_0::SessionType sessionType, getProviderCapabilities_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvidersFactory>> castFrom(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvidersFactory>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvidersFactory>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvidersFactory>& o);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvidersFactory>& o) {
    ...
    os += ::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvidersFactory::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_QTI_HARDWARE_BLUETOOTH_AUDIO_V2_0_IBLUETOOTHAUDIOPROVIDERSFACTORY_H
