#ifndef HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPROVIDERSFACTORY_H
#define HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPROVIDERSFACTORY_H
 ...
 */
struct ANDROIDHARDWAREBLUETOOTHAUDIO21_API IBluetoothAudioProvidersFactory : public ::android::hidl::base::V1_0::IBase {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.mediatek.hardware.bluetooth.audio@2.1::IBluetoothAudioProvidersFactory"
     */
     ...
     */
    virtual ::android::hardware::Return<void> openProvider(::vendor::mediatek::hardware::bluetooth::audio::V2_1::SessionType sessionType, openProvider_cb _hidl_cb) = 0;
     ...
     *    encoding.
     */
    virtual ::android::hardware::Return<void> getProviderCapabilities(::vendor::mediatek::hardware::bluetooth::audio::V2_1::SessionType sessionType, getProviderCapabilities_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory>> castFrom(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory>& o);
...
static inline std::string toString(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory>& o) {
    ...
    os += ::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPROVIDERSFACTORY_H
