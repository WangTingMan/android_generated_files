#ifndef HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPROVIDER_H
#define HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPROVIDER_H
 ...
 */
struct ANDROIDHARDWAREBLUETOOTHAUDIO21_API IBluetoothAudioProvider : public ::android::hidl::base::V1_0::IBase {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.mediatek.hardware.bluetooth.audio@2.1::IBluetoothAudioProvider"
     */
    static inline constexpr const char* descriptor = "vendor.mediatek.hardware.bluetooth.audio@2.1::IBluetoothAudioProvider";
     ...
     */
    virtual ::android::hardware::Return<void> startSession(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioPort>& hostIf, const ::vendor::mediatek::hardware::bluetooth::audio::V2_1::AudioConfiguration& audioConfig, startSession_cb _hidl_cb) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> streamStarted(::vendor::mediatek::hardware::bluetooth::audio::V2_1::Status status) = 0;
     ...
     * @param status SUCCESS or FAILURE
     */
    virtual ::android::hardware::Return<void> streamSuspended(::vendor::mediatek::hardware::bluetooth::audio::V2_1::Status status) = 0;
     ...
     * For game mode
     */
    virtual ::android::hardware::Return<void> enterGameMode(uint8_t enter) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvider>> castFrom(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvider>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvider>& o);
...
static inline std::string toString(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvider>& o) {
    ...
    os += ::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvider::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPROVIDER_H
