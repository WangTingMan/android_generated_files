#ifndef HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPORT_H
#define HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPORT_H
 ...
 */
struct ANDROIDHARDWAREBLUETOOTHAUDIO21_API IBluetoothAudioPort : public ::android::hidl::base::V1_0::IBase {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.mediatek.hardware.bluetooth.audio@2.1::IBluetoothAudioPort"
     */
    static inline constexpr const char* descriptor = "vendor.mediatek.hardware.bluetooth.audio@2.1::IBluetoothAudioPort";
     ...
     */
    using getPresentationPosition_cb = std::function<void(::vendor::mediatek::hardware::bluetooth::audio::V2_1::Status status, uint64_t remoteDeviceAudioDelayNanos, uint64_t transmittedOctets, const ::vendor::mediatek::hardware::bluetooth::audio::V2_1::TimeSpec& transmittedOctetsTimeStamp)>;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioPort>> castFrom(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioPort>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioPort>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioPort>& o);
...
static inline std::string toString(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioPort>& o) {
    ...
    os += ::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioPort::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPORT_H
