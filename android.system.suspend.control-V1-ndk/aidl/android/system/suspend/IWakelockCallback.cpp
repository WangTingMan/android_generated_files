...
namespace system {
namespace suspend {
static binder_status_t _aidl_android_system_suspend_IWakelockCallback_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  (void)_aidl_in;
  (void)_aidl_out;
...
static const char* _g_aidl_android_system_suspend_IWakelockCallback_clazz_code_to_function[] = { "notifyAcquired","notifyReleased",};
static AIBinder_Class* _g_aidl_android_system_suspend_IWakelockCallback_clazz = ::ndk::ICInterface::defineClass(IWakelockCallback::descriptor, _aidl_android_system_suspend_IWakelockCallback_onTransact, _g_aidl_android_system_suspend_IWakelockCallback_clazz_code_to_function, 2);
...
::ndk::SpAIBinder BnWakelockCallback::createBinder() {
  AIBinder* binder = AIBinder_new(_g_aidl_android_system_suspend_IWakelockCallback_clazz, static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
std::shared_ptr<IWakelockCallback> IWakelockCallback::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_system_suspend_IWakelockCallback_clazz)) {
