...
static binder_status_t _aidl_android_hardware_bluetooth_ranging_IBluetoothChannelSounding_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  ...
  switch (_aidl_code) {
    ...
    case (FIRST_CALL_TRANSACTION + 4 /*getSupportedCsSecurityLevels*/): {
      std::vector<::aidl::android::hardware::bluetooth::ranging::CsSecurityLevel> _aidl_return;

      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->getSupportedCsSecurityLevels(&_aidl_return);
      _aidl_ret_status = AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) break;
...
static const char* _g_aidl_android_hardware_bluetooth_ranging_IBluetoothChannelSounding_clazz_code_to_function[] = { "getVendorSpecificData","getSupportedSessionTypes","getMaxSupportedCsSecurityLevel","openSession","getSupportedCsSecurityLevels",};
...
::ndk::ScopedAStatus BpBluetoothChannelSounding::getSupportedCsSecurityLevels(std::vector<::aidl::android::hardware::bluetooth::ranging::CsSecurityLevel>* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  _aidl_ret_status = AIBinder_transact(
    asBinderReference().get(),
    (FIRST_CALL_TRANSACTION + 4 /*getSupportedCsSecurityLevels*/),
    _aidl_in.getR(),
    _aidl_out.getR(),
    0
    #ifdef BINDER_STABILITY_SUPPORT
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IBluetoothChannelSounding::getDefaultImpl()) {
    _aidl_status = IBluetoothChannelSounding::getDefaultImpl()->getSupportedCsSecurityLevels(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus IBluetoothChannelSoundingDefault::getSupportedCsSecurityLevels(std::vector<::aidl::android::hardware::bluetooth::ranging::CsSecurityLevel>* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
