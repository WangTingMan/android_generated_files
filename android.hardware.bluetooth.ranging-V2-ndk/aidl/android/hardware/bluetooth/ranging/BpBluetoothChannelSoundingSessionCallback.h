...
namespace bluetooth {
namespace ranging {
class ANDROIDHARDWAREBLUETOOTHRANGINGV2NDK_API BpBluetoothChannelSoundingSessionCallback : public ::ndk::BpCInterface<IBluetoothChannelSoundingSessionCallback> {
public:
