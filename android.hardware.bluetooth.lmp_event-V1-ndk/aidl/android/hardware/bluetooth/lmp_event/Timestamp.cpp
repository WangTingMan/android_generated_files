...
namespace bluetooth {
namespace lmp_event {
const char* Timestamp::descriptor = "android.hardware.bluetooth.lmp_event.Timestamp";
...
binder_status_t Timestamp::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &systemTimeUs);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &bluetoothTimeUs);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
...
binder_status_t Timestamp::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, systemTimeUs);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, bluetoothTimeUs);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
