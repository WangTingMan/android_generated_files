...
namespace bluetooth {
namespace lmp_event {
[[nodiscard]] static inline std::string toString(LmpEventId val) {
  switch(val) {
...
template <>
constexpr inline std::array<aidl::android::hardware::bluetooth::lmp_event::LmpEventId, 2> enum_values<aidl::android::hardware::bluetooth::lmp_event::LmpEventId> = {
  aidl::android::hardware::bluetooth::lmp_event::LmpEventId::CONNECT_IND,
  aidl::android::hardware::bluetooth::lmp_event::LmpEventId::LL_PHY_UPDATE_IND,
};
