...
::android::hardware::Return<void> IBluetoothAudioProvidersFactory::getHashChain(getHashChain_cb _hidl_cb){
    ...
    uint8_t v1Detailes[] = { 98,183,62,161,97,224,151,205,118,14,136,82,83,247,9,204,61,174,141,103,176,162,167,171,35,134,135,122,174,65,177,91 };
    for( auto i = 0; i < 32; ++i )
    {
        v1[i] = v1Detailes[i];
    }

    uint8_t v2Detailes[] = { 199,124,149,101,13,48,20,251,8,148,225,30,225,130,216,152,240,150,176,137,221,17,122,111,144,52,57,201,215,129,87,247 };
    for( auto i = 0; i < 32; ++i )
    {
        v2[i] = v2Detailes[i];
    }
