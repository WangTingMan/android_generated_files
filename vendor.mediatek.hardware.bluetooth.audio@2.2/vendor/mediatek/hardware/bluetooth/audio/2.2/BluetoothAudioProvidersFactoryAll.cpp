#define LOG_TAG "vendor.mediatek.hardware.bluetooth.audio@2.2::BluetoothAudioProvidersFactory"
...
#include <vendor/mediatek/hardware/bluetooth/audio/2.2/BpHwBluetoothAudioProvidersFactory.h>
#include <vendor/mediatek/hardware/bluetooth/audio/2.2/BnHwBluetoothAudioProvidersFactory.h>
#include <vendor/mediatek/hardware/bluetooth/audio/2.2/BsBluetoothAudioProvidersFactory.h>
...
const char* IBluetoothAudioProvidersFactory::descriptor("vendor.mediatek.hardware.bluetooth.audio@2.2::IBluetoothAudioProvidersFactory");
...
// no default implementation for: ::android::hardware::Return<void> IBluetoothAudioProvidersFactory::openProvider_2_1(::vendor::mediatek::hardware::bluetooth::audio::V2_2::SessionType sessionType, openProvider_2_1_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<void> IBluetoothAudioProvidersFactory::getProviderCapabilities_2_1(::vendor::mediatek::hardware::bluetooth::audio::V2_2::SessionType sessionType, getProviderCapabilities_2_1_cb _hidl_cb)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> IBluetoothAudioProvidersFactory::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvidersFactory::descriptor,
...
::android::hardware::Return<void> IBluetoothAudioProvidersFactory::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvidersFactory::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IBluetoothAudioProvidersFactory::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){98,183,62,161,97,224,151,205,118,14,136,82,83,247,9,204,61,174,141,103,176,162,167,171,35,134,135,122,174,65,177,91} /* 62b73ea161e097cd760e885253f709cc3dae8d67b0a2a7ab2386877aae41b15b */,
        (uint8_t[32]){199,124,149,101,13,48,20,251,8,148,225,30,225,130,216,152,240,150,176,137,221,17,122,111,144,52,57,201,215,129,87,247} /* c77c95650d3014fb0894e11ee182d898f096b089dd117a6f903439c9d78157f7 */,
...
::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvidersFactory>> IBluetoothAudioProvidersFactory::castFrom(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvidersFactory>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvidersFactory>> IBluetoothAudioProvidersFactory::castFrom(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IBluetoothAudioProvidersFactory, ::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory, BpHwBluetoothAudioProvidersFactory>(
            parent, "vendor.mediatek.hardware.bluetooth.audio@2.2::IBluetoothAudioProvidersFactory", emitError);
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvidersFactory>> IBluetoothAudioProvidersFactory::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwBluetoothAudioProvidersFactory::BpHwBluetoothAudioProvidersFactory(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IBluetoothAudioProvidersFactory>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("vendor.mediatek.hardware.bluetooth.audio@2.2", "IBluetoothAudioProvidersFactory") {
}
...
// Methods from ::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvidersFactory follow.
::android::hardware::Return<void> BpHwBluetoothAudioProvidersFactory::_hidl_openProvider_2_1(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::vendor::mediatek::hardware::bluetooth::audio::V2_2::SessionType sessionType, openProvider_2_1_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.mediatek.hardware.bluetooth.audio", "2.2", "IBluetoothAudioProvidersFactory", "openProvider_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(3 /* openProvider_2_1 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvider> _hidl_out_provider;
...

        {
            ...
            _hidl_out_provider = ::android::hardware::fromBinder<::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvider,::vendor::mediatek::hardware::bluetooth::audio::V2_2::BpHwBluetoothAudioProvider,::vendor::mediatek::hardware::bluetooth::audio::V2_2::BnHwBluetoothAudioProvider>(_hidl_binder);
        }
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.mediatek.hardware.bluetooth.audio", "2.2", "IBluetoothAudioProvidersFactory", "openProvider_2_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBluetoothAudioProvidersFactory::_hidl_getProviderCapabilities_2_1(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::vendor::mediatek::hardware::bluetooth::audio::V2_2::SessionType sessionType, getProviderCapabilities_2_1_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&sessionType);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.mediatek.hardware.bluetooth.audio", "2.2", "IBluetoothAudioProvidersFactory", "getProviderCapabilities_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(4 /* getProviderCapabilities_2_1 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        const ::android::hardware::hidl_vec<::vendor::mediatek::hardware::bluetooth::audio::V2_2::AudioCapabilities>* _hidl_out_audioCapabilities;
        ...
        _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                const_cast<::android::hardware::hidl_vec<::vendor::mediatek::hardware::bluetooth::audio::V2_2::AudioCapabilities> &>(*_hidl_out_audioCapabilities),
                _hidl_reply,
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.mediatek.hardware.bluetooth.audio", "2.2", "IBluetoothAudioProvidersFactory", "getProviderCapabilities_2_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvidersFactory follow.
::android::hardware::Return<void> BpHwBluetoothAudioProvidersFactory::openProvider_2_1(::vendor::mediatek::hardware::bluetooth::audio::V2_2::SessionType sessionType, openProvider_2_1_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::mediatek::hardware::bluetooth::audio::V2_2::BpHwBluetoothAudioProvidersFactory::_hidl_openProvider_2_1(this, this, sessionType, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwBluetoothAudioProvidersFactory::getProviderCapabilities_2_1(::vendor::mediatek::hardware::bluetooth::audio::V2_2::SessionType sessionType, getProviderCapabilities_2_1_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::mediatek::hardware::bluetooth::audio::V2_2::BpHwBluetoothAudioProvidersFactory::_hidl_getProviderCapabilities_2_1(this, this, sessionType, _hidl_cb);
...
BnHwBluetoothAudioProvidersFactory::BnHwBluetoothAudioProvidersFactory(const ::android::sp<IBluetoothAudioProvidersFactory> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "vendor.mediatek.hardware.bluetooth.audio@2.2", "IBluetoothAudioProvidersFactory") { 
...
::android::status_t BnHwBluetoothAudioProvidersFactory::_hidl_openProvider_2_1(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&sessionType);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.mediatek.hardware.bluetooth.audio", "2.2", "IBluetoothAudioProvidersFactory", "openProvider_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_provider);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.mediatek.hardware.bluetooth.audio", "2.2", "IBluetoothAudioProvidersFactory", "openProvider_2_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBluetoothAudioProvidersFactory::_hidl_getProviderCapabilities_2_1(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&sessionType);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.mediatek.hardware.bluetooth.audio", "2.2", "IBluetoothAudioProvidersFactory", "getProviderCapabilities_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_audioCapabilities);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.mediatek.hardware.bluetooth.audio", "2.2", "IBluetoothAudioProvidersFactory", "getProviderCapabilities_2_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBluetoothAudioProvidersFactory::onTransact(
    ...
    switch (_hidl_code) {
        ...
        {
            _hidl_err = ::vendor::mediatek::hardware::bluetooth::audio::V2_2::BnHwBluetoothAudioProvidersFactory::_hidl_openProvider_2_1(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 4 /* getProviderCapabilities_2_1 */:
        {
            _hidl_err = ::vendor::mediatek::hardware::bluetooth::audio::V2_2::BnHwBluetoothAudioProvidersFactory::_hidl_getProviderCapabilities_2_1(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsBluetoothAudioProvidersFactory::BsBluetoothAudioProvidersFactory(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvidersFactory> impl) : ::android::hardware::details::HidlInstrumentor("vendor.mediatek.hardware.bluetooth.audio@2.2", "IBluetoothAudioProvidersFactory"), mImpl(impl) {
...
bool IBluetoothAudioProvidersFactory::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("vendor.mediatek.hardware.bluetooth.audio@2.2::IBluetoothAudioProvidersFactory",
