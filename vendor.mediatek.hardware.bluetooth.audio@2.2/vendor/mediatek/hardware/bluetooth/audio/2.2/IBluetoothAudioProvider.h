#ifndef HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_BLUETOOTH_AUDIO_V2_2_IBLUETOOTHAUDIOPROVIDER_H
#define HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_BLUETOOTH_AUDIO_V2_2_IBLUETOOTHAUDIOPROVIDER_H
 ...
 */
struct ANDROIDHARDWAREBLUETOOTHAUDIO22_API IBluetoothAudioProvider : public ::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvider {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.mediatek.hardware.bluetooth.audio@2.2::IBluetoothAudioProvider"
     */
    static inline constexpr const char* descriptor = "vendor.mediatek.hardware.bluetooth.audio@2.2::IBluetoothAudioProvider";
     ...
     */
    using startSession_cb = std::function<void(::vendor::mediatek::hardware::bluetooth::audio::V2_1::Status status, const ::android::hardware::MQDescriptorSync<uint8_t>& dataMQ)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<void> startSession(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioPort>& hostIf, const ::vendor::mediatek::hardware::bluetooth::audio::V2_1::AudioConfiguration& audioConfig, startSession_cb _hidl_cb) override = 0;
     ...
     */
    virtual ::android::hardware::Return<void> streamStarted(::vendor::mediatek::hardware::bluetooth::audio::V2_1::Status status) override = 0;
     ...
     * @param status SUCCESS or FAILURE
     */
    virtual ::android::hardware::Return<void> streamSuspended(::vendor::mediatek::hardware::bluetooth::audio::V2_1::Status status) override = 0;

    /**
     * Ends the current session and unregisters the IBluetoothAudioPort
     * interface.
     */
    virtual ::android::hardware::Return<void> endSession() override = 0;

    /**
     * For game mode
     */
    virtual ::android::hardware::Return<void> enterGameMode(uint8_t enter) override = 0;

    /**
     * Return callback for startSession_2_1
     */
    using startSession_2_1_cb = std::function<void(::vendor::mediatek::hardware::bluetooth::audio::V2_1::Status status, const ::android::hardware::MQDescriptorSync<uint8_t>& dataMQ)>;
    /**
     * This method indicates that the Bluetooth stack is ready to stream audio.
     * It registers an instance of IBluetoothAudioPort with and provides the
     * current negotiated codec to the Audio HAL. After this method is called,
     ...
     */
    virtual ::android::hardware::Return<void> startSession_2_1(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioPort>& hostIf, const ::vendor::mediatek::hardware::bluetooth::audio::V2_2::AudioConfiguration& audioConfig, startSession_2_1_cb _hidl_cb) = 0;

    /**
     * Update connection parameter for HAL
     */
    virtual ::android::hardware::Return<void> updataConnParam(const ::vendor::mediatek::hardware::bluetooth::audio::V2_2::ConnParam& connPrameter) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvider>> castFrom(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvider>> castFrom(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvider>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvider>& o);
...
static inline std::string toString(const ::android::sp<::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvider>& o) {
    ...
    os += ::vendor::mediatek::hardware::bluetooth::audio::V2_2::IBluetoothAudioProvider::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_BLUETOOTH_AUDIO_V2_2_IBLUETOOTHAUDIOPROVIDER_H
