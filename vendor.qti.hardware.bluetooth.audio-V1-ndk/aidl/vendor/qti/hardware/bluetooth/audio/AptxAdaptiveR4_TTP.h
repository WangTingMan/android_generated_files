...
namespace bluetooth {
namespace audio {
class VENDORQTIHARDWAREBLUETOOTHAUDIOV1NDK_API AptxAdaptiveR4_TTP {
public:
  typedef std::false_type fixed_size;
  static inline constexpr const char* descriptor = "vendor.qti.hardware.bluetooth.audio.AptxAdaptiveR4_TTP";
