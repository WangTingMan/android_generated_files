...
namespace bluetooth {
namespace audio {
class classicVendorCapabilities {
public:
  typedef std::false_type fixed_size;
  static const char* descriptor;

  class AptxAdaptiveR4Capabilities {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  public:
    ...
    template <typename _Tp, typename = std::enable_if_t<
        _not_self<_Tp> &&
        std::is_constructible_v<std::variant<::aidl::vendor::qti::hardware::bluetooth::audio::classicVendorCapabilities::AptxAdaptiveR4Capabilities>, _Tp>
      >>
