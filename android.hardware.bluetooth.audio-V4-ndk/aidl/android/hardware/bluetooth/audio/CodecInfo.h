...
namespace bluetooth {
namespace audio {
class ANDROIDHARDWAREBLUETOOTHAUDIOV4NDK_EXPORTS_API CodecInfo {
public:
  ...
  class ANDROIDHARDWAREBLUETOOTHAUDIOV4NDK_EXPORTS_API Hfp {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREBLUETOOTHAUDIOV4NDK_EXPORTS_API LeAudio {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREBLUETOOTHAUDIOV4NDK_EXPORTS_API Transport {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
