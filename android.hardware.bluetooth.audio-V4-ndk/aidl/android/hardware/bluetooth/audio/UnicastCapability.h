...
namespace bluetooth {
namespace audio {
class ANDROIDHARDWAREBLUETOOTHAUDIOV4NDK_EXPORTS_API UnicastCapability {
public:
  typedef std::false_type fixed_size;
  static const char* descriptor;

  class ANDROIDHARDWAREBLUETOOTHAUDIOV4NDK_EXPORTS_API VendorCapabilities {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREBLUETOOTHAUDIOV4NDK_EXPORTS_API LeAudioCodecCapabilities {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
    ...
    template <typename _Tp, typename = std::enable_if_t<
        _not_self<_Tp> &&
        std::is_constructible_v<std::variant<::aidl::android::hardware::bluetooth::audio::Lc3Capabilities, ::aidl::android::hardware::bluetooth::audio::UnicastCapability::VendorCapabilities, ::aidl::android::hardware::bluetooth::audio::AptxAdaptiveLeCapabilities>, _Tp>
      >>
