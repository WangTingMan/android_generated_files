...
namespace bluetooth {
namespace audio {
class ANDROIDHARDWAREBLUETOOTHAUDIOV4NDK_EXPORTS_API A2dpStreamConfiguration {
public:
  typedef std::false_type fixed_size;
  inline static constexpr const char* descriptor = "android.hardware.bluetooth.audio.A2dpStreamConfiguration";
