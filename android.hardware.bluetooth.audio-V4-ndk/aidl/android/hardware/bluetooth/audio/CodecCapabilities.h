...
namespace bluetooth {
namespace audio {
class ANDROIDHARDWAREBLUETOOTHAUDIOV4NDK_EXPORTS_API CodecCapabilities {
public:
  ...
  class ANDROIDHARDWAREBLUETOOTHAUDIOV4NDK_EXPORTS_API Capabilities {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
