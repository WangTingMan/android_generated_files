...
const char* IBluetoothAudioCallbacks::descriptor("com.qualcomm.qti.bluetooth_audio@1.0::IBluetoothAudioCallbacks");
...
::android::hardware::Return<void> IBluetoothAudioCallbacks::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){143,13,68,168,80,73,110,106,116,180,79,250,230,97,43,91,135,119,65,238,131,191,36,145,140,194,87,181,208,248,147,78} /* 8f0d44a850496e6a74b44ffae6612b5b877741ee83bf24918cc257b5d0f8934e */,
