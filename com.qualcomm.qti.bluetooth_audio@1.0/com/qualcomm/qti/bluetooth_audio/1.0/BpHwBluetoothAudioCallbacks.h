...
struct COMQUALCOMMQTIBLUETOOTHAUDIO10_EXPORTS_API BpHwBluetoothAudioCallbacks : public ::android::hardware::BpInterface<IBluetoothAudioCallbacks>, public ::android::hardware::details::HidlInstrumentor {
