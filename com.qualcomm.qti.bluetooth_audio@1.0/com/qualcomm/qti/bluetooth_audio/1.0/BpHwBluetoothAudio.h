...
struct COMQUALCOMMQTIBLUETOOTHAUDIO10_EXPORTS_API BpHwBluetoothAudio : public ::android::hardware::BpInterface<IBluetoothAudio>, public ::android::hardware::details::HidlInstrumentor {
