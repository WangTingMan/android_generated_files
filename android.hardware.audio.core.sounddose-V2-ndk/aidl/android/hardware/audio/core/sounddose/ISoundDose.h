...
class ANDROIDHARDWAREAUDIOCORESOUNDDOSEV2NDK_API ISoundDose : public ::ndk::ICInterface {
public:
  ...
  class ANDROIDHARDWAREAUDIOCORESOUNDDOSEV2NDK_API IHalSoundDoseCallback : public ::ndk::ICInterface {
  public:
    ...
    class ANDROIDHARDWAREAUDIOCORESOUNDDOSEV2NDK_API MelRecord {
    public:
    ...
    static inline const std::string hash = "daed2ce165b383deb25a388fb04396a6b53746f3";
  ...
  class ANDROIDHARDWAREAUDIOCORESOUNDDOSEV2NDK_API IHalSoundDoseCallbackDefault : public IHalSoundDoseCallback {
  public:
  ...
  class ANDROIDHARDWAREAUDIOCORESOUNDDOSEV2NDK_API BpHalSoundDoseCallback : public ::ndk::BpCInterface<IHalSoundDoseCallback> {
  public:
  ...
  class ANDROIDHARDWAREAUDIOCORESOUNDDOSEV2NDK_API BnHalSoundDoseCallback : public ::ndk::BnCInterface<IHalSoundDoseCallback> {
  public:
...
class ANDROIDHARDWAREAUDIOCORESOUNDDOSEV2NDK_API ISoundDoseDefault : public ISoundDose {
public:
