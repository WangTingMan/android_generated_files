#ifndef ANDROID_AUDIO_POLICY_CONFIGURATION_H
#define ANDROID_AUDIO_POLICY_CONFIGURATION_H
            ...
            namespace configuration {
                ...
                class MixPorts {
                    ...
                    class MixPort {
                        ...
                        const std::optional<unsigned int> recommendedMuteDurationMs_;
                        public:
                        MixPort(std::vector<Profile> profile, std::vector<Gains> gains, std::string name, Role role, std::optional<std::vector<AudioInOutFlag>> flags, std::optional<unsigned int> maxOpenCount, std::optional<unsigned int> maxActiveCount, std::optional<unsigned int> recommendedMuteDurationMs);
                        ...
                        const unsigned int& getRecommendedMuteDurationMs() const;
                        bool hasRecommendedMuteDurationMs() const;
                ...
                class Profile {
                    ...
                    public:
                    Profile(std::optional<std::string> format, std::optional<std::vector<int64_t>> samplingRates, std::optional<std::vector<AudioChannelMask>> channelMasks);
                ...
                class Gains {
                    ...
                    class Gain {
                        ...
                        public:
                        Gain(std::vector<AudioGainMode> mode, std::optional<AudioChannelMask> channel_mask, std::optional<int> minValueMB, std::optional<int> maxValueMB, std::optional<int> defaultValueMB, std::optional<int> stepValueMB, std::optional<int> minRampMs, std::optional<int> maxRampMs, std::optional<bool> useForVolume);
...
#endif // ANDROID_AUDIO_POLICY_CONFIGURATION_H
