        ...
        namespace policy {
            namespace configuration {
                ...
                const std::map<std::string, AudioInOutFlag> AudioInOutFlagString {
                    ...
                    { "AUDIO_OUTPUT_FLAG_SPATIALIZER", AudioInOutFlag::AUDIO_OUTPUT_FLAG_SPATIALIZER },
                    { "AUDIO_OUTPUT_FLAG_ULTRASOUND", AudioInOutFlag::AUDIO_OUTPUT_FLAG_ULTRASOUND },
                    { "AUDIO_OUTPUT_FLAG_BIT_PERFECT", AudioInOutFlag::AUDIO_OUTPUT_FLAG_BIT_PERFECT },
                    ...
                    { "AUDIO_INPUT_FLAG_ULTRASOUND", AudioInOutFlag::AUDIO_INPUT_FLAG_ULTRASOUND },
                    { "AUDIO_INPUT_FLAG_HOTWORD_TAP", AudioInOutFlag::AUDIO_INPUT_FLAG_HOTWORD_TAP },
                    { "AUDIO_INPUT_FLAG_HW_LOOKBACK", AudioInOutFlag::AUDIO_INPUT_FLAG_HW_LOOKBACK },
                };
                ...
                std::string toString(AudioInOutFlag o) {
                    switch (o) {
                        ...
                        case AudioInOutFlag::AUDIO_OUTPUT_FLAG_SPATIALIZER: return "AUDIO_OUTPUT_FLAG_SPATIALIZER";
                        case AudioInOutFlag::AUDIO_OUTPUT_FLAG_ULTRASOUND: return "AUDIO_OUTPUT_FLAG_ULTRASOUND";
                        case AudioInOutFlag::AUDIO_OUTPUT_FLAG_BIT_PERFECT: return "AUDIO_OUTPUT_FLAG_BIT_PERFECT";
                        ...
                        case AudioInOutFlag::AUDIO_INPUT_FLAG_ULTRASOUND: return "AUDIO_INPUT_FLAG_ULTRASOUND";
                        case AudioInOutFlag::AUDIO_INPUT_FLAG_HOTWORD_TAP: return "AUDIO_INPUT_FLAG_HOTWORD_TAP";
                        case AudioInOutFlag::AUDIO_INPUT_FLAG_HW_LOOKBACK: return "AUDIO_INPUT_FLAG_HW_LOOKBACK";
                        default: return std::to_string(static_cast<int>(o));
                    }
                }
                ...
                const std::map<std::string, AudioDevice> AudioDeviceString {
                    ...
                    { "AUDIO_DEVICE_OUT_BLE_BROADCAST", AudioDevice::AUDIO_DEVICE_OUT_BLE_BROADCAST },
                ...
                std::string toString(AudioDevice o) {
                    switch (o) {
                        ...
                        case AudioDevice::AUDIO_DEVICE_OUT_BLE_BROADCAST: return "AUDIO_DEVICE_OUT_BLE_BROADCAST";
                ...
                const std::map<std::string, AudioFormat> AudioFormatString {
                    ...
                    { "AUDIO_FORMAT_APTX_ADAPTIVE_QLEA", AudioFormat::AUDIO_FORMAT_APTX_ADAPTIVE_QLEA },
                    { "AUDIO_FORMAT_APTX_ADAPTIVE_R4", AudioFormat::AUDIO_FORMAT_APTX_ADAPTIVE_R4 },
                    { "AUDIO_FORMAT_DTS_HD_MA", AudioFormat::AUDIO_FORMAT_DTS_HD_MA },
                    { "AUDIO_FORMAT_DTS_UHD_P2", AudioFormat::AUDIO_FORMAT_DTS_UHD_P2 },
                };
                ...
                std::string toString(AudioFormat o) {
                    switch (o) {
                        ...
                        case AudioFormat::AUDIO_FORMAT_APTX_ADAPTIVE_QLEA: return "AUDIO_FORMAT_APTX_ADAPTIVE_QLEA";
                        case AudioFormat::AUDIO_FORMAT_APTX_ADAPTIVE_R4: return "AUDIO_FORMAT_APTX_ADAPTIVE_R4";
                        case AudioFormat::AUDIO_FORMAT_DTS_HD_MA: return "AUDIO_FORMAT_DTS_HD_MA";
                        case AudioFormat::AUDIO_FORMAT_DTS_UHD_P2: return "AUDIO_FORMAT_DTS_UHD_P2";
                        default: return std::to_string(static_cast<int>(o));
                    }
                }
                ...
                const std::map<std::string, AudioChannelMask> AudioChannelMaskString {
                    ...
                    { "AUDIO_CHANNEL_OUT_9POINT1POINT4", AudioChannelMask::AUDIO_CHANNEL_OUT_9POINT1POINT4 },
                    { "AUDIO_CHANNEL_OUT_9POINT1POINT6", AudioChannelMask::AUDIO_CHANNEL_OUT_9POINT1POINT6 },
                    ...
                    { "AUDIO_CHANNEL_IN_2POINT1", AudioChannelMask::AUDIO_CHANNEL_IN_2POINT1 },
                    { "AUDIO_CHANNEL_IN_FRONT_BACK", AudioChannelMask::AUDIO_CHANNEL_IN_FRONT_BACK },
                    { "AUDIO_CHANNEL_IN_TRI", AudioChannelMask::AUDIO_CHANNEL_IN_TRI },
                    { "AUDIO_CHANNEL_IN_3POINT1", AudioChannelMask::AUDIO_CHANNEL_IN_3POINT1 },
                    ...
                    { "AUDIO_CHANNEL_IN_QUAD", AudioChannelMask::AUDIO_CHANNEL_IN_QUAD },
                    { "AUDIO_CHANNEL_IN_PENTA", AudioChannelMask::AUDIO_CHANNEL_IN_PENTA },
                ...
                std::string toString(AudioChannelMask o) {
                    switch (o) {
                        ...
                        case AudioChannelMask::AUDIO_CHANNEL_OUT_9POINT1POINT4: return "AUDIO_CHANNEL_OUT_9POINT1POINT4";
                        case AudioChannelMask::AUDIO_CHANNEL_OUT_9POINT1POINT6: return "AUDIO_CHANNEL_OUT_9POINT1POINT6";
                        ...
                        case AudioChannelMask::AUDIO_CHANNEL_IN_2POINT1: return "AUDIO_CHANNEL_IN_2POINT1";
                        case AudioChannelMask::AUDIO_CHANNEL_IN_FRONT_BACK: return "AUDIO_CHANNEL_IN_FRONT_BACK";
                        case AudioChannelMask::AUDIO_CHANNEL_IN_TRI: return "AUDIO_CHANNEL_IN_TRI";
                        case AudioChannelMask::AUDIO_CHANNEL_IN_3POINT1: return "AUDIO_CHANNEL_IN_3POINT1";
                        ...
                        case AudioChannelMask::AUDIO_CHANNEL_IN_QUAD: return "AUDIO_CHANNEL_IN_QUAD";
                        case AudioChannelMask::AUDIO_CHANNEL_IN_PENTA: return "AUDIO_CHANNEL_IN_PENTA";
                ...
                const std::map<std::string, AudioSource> AudioSourceString {
                    ...
                    { "AUDIO_SOURCE_ULTRASOUND", AudioSource::AUDIO_SOURCE_ULTRASOUND },
                };
                ...
                std::string toString(AudioSource o) {
                    switch (o) {
                        ...
                        case AudioSource::AUDIO_SOURCE_ULTRASOUND: return "AUDIO_SOURCE_ULTRASOUND";
                        default: return std::to_string(static_cast<int>(o));
                    }
                }
