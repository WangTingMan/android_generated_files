...
namespace audio {
namespace common {
class ANDROIDMEDIAAUDIOCOMMONTYPESV3NDK_API MicrophoneInfo {
public:
  ...
  class ANDROIDMEDIAAUDIOCOMMONTYPESV3NDK_API Sensitivity {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDMEDIAAUDIOCOMMONTYPESV3NDK_API FrequencyResponsePoint {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDMEDIAAUDIOCOMMONTYPESV3NDK_API Coordinate {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
