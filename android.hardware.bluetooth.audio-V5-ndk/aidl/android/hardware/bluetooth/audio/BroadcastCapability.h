...
namespace bluetooth {
namespace audio {
class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API BroadcastCapability {
public:
  typedef std::false_type fixed_size;
  static const char* descriptor;

  class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API VendorCapabilities {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API LeAudioCodecCapabilities {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
