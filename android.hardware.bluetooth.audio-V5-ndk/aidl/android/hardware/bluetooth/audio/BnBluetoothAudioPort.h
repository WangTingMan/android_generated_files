...
namespace bluetooth {
namespace audio {
class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API BnBluetoothAudioPort : public ::ndk::BnCInterface<IBluetoothAudioPort> {
public:
...
class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API IBluetoothAudioPortDelegator : public BnBluetoothAudioPort {
public:
