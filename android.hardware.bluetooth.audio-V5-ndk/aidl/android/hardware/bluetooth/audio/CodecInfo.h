...
namespace bluetooth {
namespace audio {
class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API CodecInfo {
public:
  typedef std::false_type fixed_size;
  static const char* descriptor;

  class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API A2dp {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API Hfp {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API LeAudio {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API Transport {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
