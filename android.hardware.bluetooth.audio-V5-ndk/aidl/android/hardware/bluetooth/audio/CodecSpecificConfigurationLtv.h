...
namespace bluetooth {
namespace audio {
class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API CodecSpecificConfigurationLtv {
public:
  ...
  class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API AudioChannelAllocation {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API OctetsPerCodecFrame {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API CodecFrameBlocksPerSDU {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
