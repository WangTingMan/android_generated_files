...
namespace bluetooth {
namespace audio {
class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API BnBluetoothAudioProviderFactory : public ::ndk::BnCInterface<IBluetoothAudioProviderFactory> {
public:
...
class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API IBluetoothAudioProviderFactoryDelegator : public BnBluetoothAudioProviderFactory {
public:
