...
namespace bluetooth {
namespace audio {
class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API CodecConfiguration {
public:
  typedef std::false_type fixed_size;
  static const char* descriptor;

  class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API VendorConfiguration {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
  ...
  class ANDROIDHARDWAREBLUETOOTHAUDIOV5NDK_API CodecSpecific {
  public:
    typedef std::false_type fixed_size;
    static const char* descriptor;
