...
const char* MessageDeliveryStatus::descriptor = "android.hardware.contexthub.MessageDeliveryStatus";

binder_status_t MessageDeliveryStatus::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t MessageDeliveryStatus::writeToParcel(AParcel* _aidl_parcel) const {
