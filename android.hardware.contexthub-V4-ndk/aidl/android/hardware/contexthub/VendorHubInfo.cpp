...
const char* VendorHubInfo::descriptor = "android.hardware.contexthub.VendorHubInfo";

binder_status_t VendorHubInfo::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t VendorHubInfo::writeToParcel(AParcel* _aidl_parcel) const {
