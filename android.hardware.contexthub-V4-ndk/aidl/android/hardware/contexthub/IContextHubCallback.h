...
class ANDROIDHARDWARECONTEXTHUBV4NDK_API IContextHubCallback : public ::ndk::ICInterface {
public:
...
class ANDROIDHARDWARECONTEXTHUBV4NDK_API IContextHubCallbackDefault : public IContextHubCallback {
public:
