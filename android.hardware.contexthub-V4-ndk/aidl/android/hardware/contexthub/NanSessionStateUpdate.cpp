...
const char* NanSessionStateUpdate::descriptor = "android.hardware.contexthub.NanSessionStateUpdate";

binder_status_t NanSessionStateUpdate::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t NanSessionStateUpdate::writeToParcel(AParcel* _aidl_parcel) const {
