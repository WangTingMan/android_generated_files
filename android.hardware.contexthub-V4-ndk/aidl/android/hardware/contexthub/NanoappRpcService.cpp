...
const char* NanoappRpcService::descriptor = "android.hardware.contexthub.NanoappRpcService";

binder_status_t NanoappRpcService::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t NanoappRpcService::writeToParcel(AParcel* _aidl_parcel) const {
