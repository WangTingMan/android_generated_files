...
namespace audio {
namespace core {
class ANDROIDHARDWAREAUDIOCOREV3NDK_API BnStreamOut : public ::ndk::BnCInterface<IStreamOut> {
public:
  BnStreamOut();
  virtual ~BnStreamOut();
...
class ANDROIDHARDWAREAUDIOCOREV3NDK_API IStreamOutDelegator : public BnStreamOut {
public:
