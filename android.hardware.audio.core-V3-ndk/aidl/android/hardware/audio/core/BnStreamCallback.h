...
namespace audio {
namespace core {
class ANDROIDHARDWAREAUDIOCOREV3NDK_API BnStreamCallback : public ::ndk::BnCInterface<IStreamCallback> {
public:
  BnStreamCallback();
...
class ANDROIDHARDWAREAUDIOCOREV3NDK_API IStreamCallbackDelegator : public BnStreamCallback {
public:
