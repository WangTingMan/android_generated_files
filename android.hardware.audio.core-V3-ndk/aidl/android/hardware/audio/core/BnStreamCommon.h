...
namespace audio {
namespace core {
class ANDROIDHARDWAREAUDIOCOREV3NDK_API BnStreamCommon : public ::ndk::BnCInterface<IStreamCommon> {
public:
  BnStreamCommon();
...
class ANDROIDHARDWAREAUDIOCOREV3NDK_API IStreamCommonDelegator : public BnStreamCommon {
public:
