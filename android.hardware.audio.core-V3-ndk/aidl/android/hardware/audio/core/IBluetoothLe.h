...
class ANDROIDHARDWAREAUDIOCOREV3NDK_API IBluetoothLe : public ::ndk::ICInterface {
public:
...
class ANDROIDHARDWAREAUDIOCOREV3NDK_API IBluetoothLeDefault : public IBluetoothLe {
public:
