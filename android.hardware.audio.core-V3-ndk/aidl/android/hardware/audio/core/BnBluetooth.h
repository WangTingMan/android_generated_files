...
namespace audio {
namespace core {
class ANDROIDHARDWAREAUDIOCOREV3NDK_API BnBluetooth : public ::ndk::BnCInterface<IBluetooth> {
public:
  BnBluetooth();
  virtual ~BnBluetooth();
...
class ANDROIDHARDWAREAUDIOCOREV3NDK_API IBluetoothDelegator : public BnBluetooth {
public:
